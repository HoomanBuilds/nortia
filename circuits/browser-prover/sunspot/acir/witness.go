...
// Modified by Nortia: added in-memory witness decoding for browser WASM proving.
...
func LoadWitnessStackFromFile[T shr.ACIRField](filePath string, modulus *big.Int) (WitnessStack[T], error) {
	...
	defer file.Close()
	return LoadWitnessStackFromReader[T](file, modulus)
}

func LoadWitnessStackFromBytes[T shr.ACIRField](data []byte, modulus *big.Int) (WitnessStack[T], error) {
	return LoadWitnessStackFromReader[T](bytes.NewReader(data), modulus)
}

func LoadWitnessStackFromReader[T shr.ACIRField](source io.Reader, modulus *big.Int) (WitnessStack[T], error) {
...
func (acir *ACIR[T, E]) GetWitness(fileName string, field *big.Int) (witness.Witness, error) {
	...
	return acir.getWitness(witnessStack, field)
}

func (acir *ACIR[T, E]) GetWitnessBytes(data []byte, field *big.Int) (witness.Witness, error) {
...
func (acir *ACIR[T, E]) getWitness(witnessStack WitnessStack[T], field *big.Int) (witness.Witness, error) {
	result, err := witness.New(field)
	if err != nil {
	...
	err = result.Fill(countPublic, countPrivate, values)
	if err != nil {
