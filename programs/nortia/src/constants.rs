...
pub const OPTIMISTIC_PROPOSAL_SEED: &[u8] = b"optimistic-proposal-v2";
pub const OPTIMISTIC_BOND_VAULT_SEED: &[u8] = b"optimistic-bond-vault-v2";
pub const HYBRID_METADATA_SEED: &[u8] = b"hybrid-metadata-v2";
