...
pub const HYBRID_MARKET_SEED: &[u8] = b"hybrid-market";
pub const HYBRID_VAULT_SEED: &[u8] = b"hybrid-vault";
pub const ORACLE_CONFIG_SEED: &[u8] = b"oracle-config";
pub const POSITION_SEED: &[u8] = b"position";
pub const RESOLUTION_RECEIPT_SEED: &[u8] = b"resolution-receipt";
pub const OPTIMISTIC_PROPOSAL_SEED: &[u8] = b"optimistic-proposal";
pub const OPTIMISTIC_BOND_VAULT_SEED: &[u8] = b"optimistic-bond-vault";
pub const HYBRID_METADATA_SEED: &[u8] = b"hybrid-metadata";
...
pub const MIN_PRIVATE_WAGER_AMOUNT: u64 = 1_000_000;
pub const DEFAULT_PRIVATE_STAKE_AMOUNT: u64 = 100_000_000;
pub const MAX_PRIVATE_STAKE_AMOUNT: u64 = 1_000_000_000;
...
pub const MIN_OPTIMISTIC_BOND: u64 = 10_000_000;
pub const OPTIMISTIC_DISPUTE_FEE_BPS: u16 = 500;
...
// Exact discriminator of TxLINE's upstream `validate_stat_v2` instruction.
pub const TXLINE_VALIDATE_STAT_DISCRIMINATOR: [u8; 8] = [208, 215, 194, 214, 241, 71, 246, 178];
