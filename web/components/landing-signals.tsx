...
const signals = [
  { code: "SSE / LIVE", title: "Resolver Feed", value: "SIGNED", note: "Connected evidence sources normalize external events into one deterministic settlement receipt. TxLINE sports is live first." },
  { code: "NOIR / ZK", title: "Private Order", value: "HIDDEN", note: "Your YES or NO side is committed locally. Individual positions never enter the public pool state." },
  { code: "SOL / PDA", title: "USDC Escrow", value: "1.00", note: "Every fixed ticket locks one devnet USDC in a neutral program-controlled vault." },
  { code: "CPI / PROOF", title: "Auto Resolve", value: "TRUSTLESS", note: "Any keeper can submit the result and invoke TxLINE validation before the vault releases payouts." },
  { code: "BPS / FEE", title: "Success Fee", value: "1.00%", note: "Nortia treasury receives 90% of the fee and the resolving keeper receives 10%. Refund paths stay fee-free." },
];
