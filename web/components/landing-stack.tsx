...
const columns = [
  ...
  { label: "Data", values: ["TxLINE SSE", "Merkle proofs", "validate_stat CPI"] },
  { label: "Privacy", values: ["Noir", "Sunspot", "Poseidon"] },
  { label: "Collateral", values: ["USDC", "Fixed tickets", "PDA escrow"] },
  { label: "Settlement", values: ["Permissionless", "Deterministic", "Fee-capped"] },
  { label: "Build", values: ["Next.js", "TypeScript", "Rust"] },
];
