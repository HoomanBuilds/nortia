...
The approved market is a fixed-ticket USDC pari-mutuel pool for total goals over 2.5. It charges a one-percent protocol fee only after successful settlement, returns full tickets on refund paths, verifies placement and redemption proofs on Solana, and uses TxLINE V2 for the final result.
