...
Private proof circuit sources and generated proving artifacts use versioned directories under `/home/ubuntu/nortia/shared/prover-releases`. The prover environment selects one complete circuit generation atomically. All proving artifacts and the prover API token use mode `0600` and remain outside Git.
